...
<p>
  ...
  <img src="https://img.shields.io/badge/version-1.0.13-rc.6-blue" alt="1.0.13-rc.6">
...
Current release line: **Grok Build 1.0 core** · wire **`1.0.13-rc.6`** — GitHub
...
| --- | --- | --- |
| `1.0.13-rc.6` | [v1.0.13-rc.6](https://github.com/danmsheets-dev/turbo-grok-build/releases/tag/v1.0.13-rc.6) | `turbo-1.0.13-rc.6-x86_64-pc-windows-msvc.zip` |
...
| **1.0.13-rc.6** | **`1.0.13-rc.6`** | **TUI third-party login:** `/login openai` (Kimi, Claude, Copilot, Radius) runs OAuth; welcome `o`/`k`/`c` without a Grok login first |
| **1.0.13-rc.5** | **`1.0.13-rc.5`** | **Windows CI gates green:** `mcp-server-windows` builds with a real `protoc.exe`; 8.3 temp-path and fresh-boot `Instant` test fixes; Repo hygiene allowlist |
...
| Release line | upstream cadence | **1.0.13-rc.6** |
...
```sh
curl -fsSL https://github.com/danmsheets-dev/turbo-grok-build/releases/latest/download/install.sh | bash -s -- --version v1.0.13-rc.6
```

```powershell
# Windows — pin this release
.\install.ps1 -Version v1.0.13-rc.6
```
...
- [`CHANGELOG.md`](./CHANGELOG.md) — **official changelog** · **1.0.13-rc.6** is current
