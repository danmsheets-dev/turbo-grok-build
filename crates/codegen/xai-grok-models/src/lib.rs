...
pub use platforms::{
    ...
    ResolvedProviderRuntime, WireModel, WireModelsResponse, WireThinkEfforts, catalog_key_is_eol,
    clamp_max_completion_tokens, derive_capabilities, filter_allowed_models,
    is_nvidia_glm_52_eol_slug, is_poolside_laguna_m1_eol_slug, is_session_scoped_catalog_id,
    kimi_allow_empty_thinking_signature, kimi_force_adaptive_thinking, kimi_request_profile,
    kimi_sampling_is_fixed, moonshot_builtin_models, nexus_chat_base, nexus_messages_base,
    nexus_normalize_root, nexus_responses_base, normalize_azure_openai_base_url,
    normalize_kimi_code_base_url, normalize_messages_sdk_base_url, nvidia_integrate_chat_compat,
    parse_managed_model_key, platform_builtin_models, poolside_hosted_chat_compat,
