    ...
    if let Some(edit) = pattern_edit {
        ...
        if show_scope_hint {
            spans.push(Span::styled(
                rust_i18n::t!("permission.scope_hint_a").to_string(),
                hint_style,
            ));
            spans.push(Span::styled("\u{2190} \u{2192}", key_style));
            spans.push(Span::styled(
                rust_i18n::t!("permission.scope_hint_b").to_string(),
                hint_style,
            ));
        }
        if show_edit_hint {
            ...
            spans.push(Span::styled(
                crate::i18n::tr_or("permission.edit_pattern_hint", " edit pattern").into_owned(),
                hint_style,
            ));
        }
