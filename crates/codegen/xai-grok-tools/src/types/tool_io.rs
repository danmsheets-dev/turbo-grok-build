...
pub enum ToolInput {
    ...
    McpServerHealth(McpServerHealthInput),
    ...
    GhPrStatus(crate::implementations::grok_build::gh::GhPrStatusInput),
    GhCiStatus(crate::implementations::grok_build::gh::GhCiStatusInput),
    GhCiRerun(crate::implementations::grok_build::gh::GhCiRerunInput),
