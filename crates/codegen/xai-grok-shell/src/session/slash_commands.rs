...
pub const PAGER_COMMAND_KEYS: &[&str] = &[
    ...
    "workspace-tree",
    "yolo",
    // Compat / alias names registered by turbo pager builtins.
    "anthropic",
];
...
impl<'a> EffectiveCommandCatalog<'a> {
    fn build(
        ...
        let builtins: Vec<_> = BUILTIN_COMMANDS
            ...
            .collect();
        // Module-level `PAGER_COMMAND_KEYS` is the source of truth (includes turbo
        // keys such as atlas/tree/workspace-tree when present there).
